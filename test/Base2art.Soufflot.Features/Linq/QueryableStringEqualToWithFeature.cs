namespace Base2art.PlayN.Features.Linq
{
    ...
    [TestFixture]
    public class QueryableStringEqualToWithFeature
    {
        [Test]
        public void ShouldFilterCorrectly()
        {
            ...
            var result = table.AsQueryable().Filter(x => x.Name, new StringCriteria { EqualTo = "Truman" });
        ...
        public void ShouldFilterNotIgnoreCaseCorrectly()
        {
            ...
            table.Add(new Person { Name = "Truman" });
            table.Add(new Person { Name = "Leat" });
            var result = table.AsQueryable().Filter(x => x.Name, new StringCriteria { StartsWith = "truman" });
        ...
        public void ShouldFilterIgnoreCaseCorrectly()
        {
            ...
            table.Add(new Person { Name = "Truman" });
            table.Add(new Person { Name = "Leat" });
            var stringCriteria = new StringCriteria { StartsWith = "trumAn" };
