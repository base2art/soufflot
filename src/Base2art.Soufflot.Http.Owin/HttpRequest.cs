namespace Base2art.Soufflot.Http.Owin
{
    ...
    public class HttpRequest : IHttpRequest
    {
        ...
        {
            get { return new HttpRequestBody(this.request, this.settings); }
        }

        public HttpCookieCollection Cookies
        {
            get { return new HttpCookieCollection(this.request.Cookies, settings); }
        }
        ...
        {
            get { return new HttpReadOnlyHeaderCollection(this.request.Headers); }
        }
        ...
        {
            get { return new HttpQueryString(this.Uri.Query ?? string.Empty); }
        }

        public HttpMethod Method
        {
            get { return ParseMethod(this.request.Method); }
        }

        public IHttpUser User
        {
            get { return this.currentUser.Value; }
        }
